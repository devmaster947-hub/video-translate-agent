...
WEIGHT_URL='https://github.com/devmaster947-hub/video-translate-agent/releases/download/v2.3.5/sttn.pth'
...
def ensure_weights():
    ...
    request=urllib.request.Request(WEIGHT_URL,headers={"User-Agent":"video-translate-agent/2.3.5"})
    try:
        total=0
